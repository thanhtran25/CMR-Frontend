                ...
                <aside class="col-lg-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr /> <a onClick={handleSwitchPaymet} class="btn btn-out btn-primary btn-square btn-main" data-abc="true"> Tiến hành thanh toán </a> <a class="btn btn-out btn-success btn-square btn-main mt-2" data-abc="true">Tiếp tục mua hàng</a>
                        </div>
                    </div>
                </aside>
            </div>
